...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/5ddadc02d54ed99c377fbb850c3d493dc1512b9d/P/protoc/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.")
...
* git repository: https://github.com/protocolbuffers/protobuf.git (revision: `fde7cf7358ec7cd69e8db9be4f1fa6a5c431386a`)
