# `protoc_jll.jl` (v3.19.4+0)

[![deps](https://juliahub.com/docs/protoc_jll/deps.svg)](https://juliahub.com/ui/Packages/protoc_jll/yhNLs?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/06bf115c666381b764ef61e54273530a0f9fc128/P/protoc/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.")
...
* git repository: https://github.com/protocolbuffers/protobuf.git (revision: `22d0e265de7d2b3d2e9a00d071313502e7d4cccf`)
